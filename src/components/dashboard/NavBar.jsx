...
const NavBar = () => {
    ...
    return (
        <nav className="fixed top-0 z-10 bg-gray-100 border-gray-200 dark:bg-gray-900 w-full ">
            <div className="max-w-screen flex flex-wrap items-center justify-between mr-[20px] p-4">
                <a href="#" className="flex items-center">
                    <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 mr-3" alt="Flowbite Logo" />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Wardrobe Apps</span>
                </a>
